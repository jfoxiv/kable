<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ManageEvents.aspx.cs" Inherits="ManageEvents" %>
...
<table>
    ...
    <td class="auto-style3"><b>Delete or Create Event:</b></td>
    </tr>
<tr>
    <td style="vertical-align:top;">        
<!-- grid view goes here -->
    <asp:GridView ID="GvEvents" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataSourceID="dataSrcGvEvents" DataKeyNames="EventID">
    ...
    <asp:SqlDataSource ID="dataSrcGvEvents" runat="server" ConnectionString="<%$ ConnectionStrings:kbelConnectionString %>" 
        SelectCommand="SELECT EventID, Categories.Name AS 'Category', Summary
                        FROM Events
    ...
    <asp:DetailsView ID="DvEvents" runat="server" Height="68px" Width="519px" AutoGenerateRows="False" DataSourceID="dataSrcDvEvents" DataKeyNames="EventID" OnItemDeleted="dvBtnDelete" OnItemInserted="dvBtnAddEvent" OnItemInserting="dvBtnSetEventCreator" OnItemUpdated="DvEvents_ItemUpdated">
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Category" SortExpression="Category">
                <EditItemTemplate>
                    <asp:DropDownList ID="ddlEventCategories" runat="server" 
                        ...
                        SelectedValue ='<%# Bind("CategoryID") %>' OnDataBinding="PreventErrorOnBinding" >
                    </asp:DropDownList>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:DropDownList ID="ddlEventCategoriesInsert" runat="server" 
                        DataSourceID="sqlDdlCategories" DataTextField="Name" 
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton11" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnClientClick="return confirm('Are you sure you want to delete this event?');"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Fields>
